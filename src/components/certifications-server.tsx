...
function groupCertificationsByYear() {
  const groupedCerts: Record<string, typeof certifications> = {};
...
export function CertificationsServer({ theme }: CertificationsServerProps) {
  const [activeTab, setActiveTab] = useState<string>("all");
  
  const groupedByYear = groupCertificationsByYear();
